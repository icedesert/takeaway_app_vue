<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="toggleNoticeShow">
        ...
        <div class="shop-message">
          <span class="shop-message-detail">评分{{shopInfo.score}}</span>
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="noticeShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toggleNoticeShow">
            <span class="iconfont icon-close"/>
          </div>
        </div>
        <div class="brief-modal-cover" @click="toggleNoticeShow"/>
      </div>
    </transition>
    <transition name="fade">
        ...
        <transition name="move">
          <div class="activity-sheet-content" v-show="supportShow">
            ...
            <div class="activity-sheet-close">
              <span class="iconfont icon-close" @click="toggleSupportShow"/>
            </div>
          </div>
        </transition>
        <div class="activity-sheet-cover" @click="toggleSupportShow"/>
      </div>
    </transition>
  </div>
</template>
